// src/data/jokes.js
// Seed jokes used by the app (moved out of index.js for separation of concerns)

export const JOKES_SEED = [
...
// default export is handy too
export default JOKES_SEED;
